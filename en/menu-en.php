<nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav">
            <li class="nav-item">
                <a href="index.php#services" class="nav-link btn btn-dark m-1">Services</a>
            </li>
            <li class="nav-item">
                <a href="index.php#locations" class="nav-link btn btn-dark m-1">Locations</a>
            </li>
            <li class="nav-item">
                <a href="contact.php" class="nav-link btn btn-dark m-1">Contact Us</a>
            </li>
            <li class="nav-item">
                <a href="about.php" class="nav-link btn btn-dark m-1">About Us</a>
            </li>
            <li class="nav-item">
